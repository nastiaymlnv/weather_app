...
const drawAnimation = (stopPosition, color) => {
    return (
        <svg className='curve' width="351" height="142" viewBox="0 0 351 142" fill="url(#left-to-right)" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <linearGradient id="left-to-right" gradientUnits="userSpaceOnUse">
                    <stop offset="0" stopColor="#333FAA" stopOpacity="0.8">
                        <animate dur="2s" attributeName="offset" fill="freeze" from="0" to={stopPosition} />
                    </stop>
    ...
    return (
        <div className='humidity-wrapper'>
            ...
            <List className={classes.humidityLegend} sx={{display: 'flex', justifyContent: 'space-between', p: '0'}}>
                <ListItemText className={classes.humidityLevel} sx={{fontSize: '12px', ml: '10px'}} disableTypography> 
                    0 
                </ListItemText>
